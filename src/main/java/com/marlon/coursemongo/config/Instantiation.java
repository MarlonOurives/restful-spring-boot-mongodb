package com.marlon.coursemongo.config;
...
import com.marlon.coursemongo.dto.AuthorDTO;
import com.marlon.coursemongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Vamos que hoje vai ser um ótimo dia", new AuthorDTO(maria));
